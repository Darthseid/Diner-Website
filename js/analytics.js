(function() {
    ...
    var oe = function() {
        ...
        ge = function(a, b, c) {
            1 <= 100 * Math.random() || G("?") ||
                (a = ["t=error", "_e=" + a, "_v=j67", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc("https://www.google-analytics.com/u/d", a.join("&"), ua))
        };
    var h = function(a) {
    ...
    var Od = function() {
        ...
        Ed = function(a) {
            ...
            if (0 == b.V) return 0;
            void 0 === c && (c = Bd());
            return 0 == c % b.V ? Math.floor(c / b.V) % b.ea + 1 : 0
        };
